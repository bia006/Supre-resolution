...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--datasetSize', type=int, default=500, help='dataset size')
        parser.add_argument('--fineSize', type=int, default=256, help='then crop to this size')
        parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels')
        parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')
        parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in first conv layer')
        parser.add_argument('--which_model_netG', type=str, default='upsample_4x', help='selects model to use for netG')
        ...
        parser.add_argument('--model', type=str, default='SR', help='chooses which model to use')
    ...
    def gather_options(self):
        ...
        opt.isVal = self.isVal

        # modify model-related parser options
        model_name = opt.model
        model_option_setter = models.get_option_setter(model_name)
        parser = model_option_setter(parser, self.isTrain)
        parser = model_option_setter(parser, self.isVal)
