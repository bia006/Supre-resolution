...
class Visualizer():
    ...
    def save_losses(self, epoch,a, x, y, z, u, v, w):
        with open('error_'+ str(a) +'.csv', 'a', newline='') as myfile:
            wr = csv.writer(myfile, delimiter=',')
            wr.writerow([str(epoch), str(x), str(y), str(z), str(u), str(v),str(w)])

    def save_val_losses(self, epoch,a, x, y, z):
        with open('error_'+ str(a) +'.csv', 'a', newline='') as myfile:
            wr = csv.writer(myfile, delimiter=',')
            wr.writerow([str(epoch), str(x), str(y), str(z)])
